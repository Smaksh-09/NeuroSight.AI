...
import { FaCloudUploadAlt, FaSpinner, FaLungs } from 'react-icons/fa';
...
export default function Lungs() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const geminiResponse = await fetch('/api/analyze-lungs', {
        method: 'POST',
        headers: {
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div ref={headerRef} className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Upload your lung scan for AI-powered analysis and early detection of potential lung tumors.
          </p>
        </div>
            ...
            <div className="w-full max-w-md">
              <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-blue-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  <FaLungs className="w-12 h-12 text-blue-500 mb-4" />
